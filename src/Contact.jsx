const Contact = () => {
  return (
    <div className="flex flex-col items-center px-6 py-12 bg-slate-700 min-h-fit">
      <div className="max-w-4xl w-full bg-white rounded-lg shadow-lg overflow-hidden flex flex-col justify-center items-center md:flex-row">
